...
import { useBatches, useActivateBatch } from "../../hooks/useAcademicQueries";
...
export default function AcademicsBatchesPage() {
  ...
  return (
    <>
      ...
      {selectedBatchId && (
        <BatchDetail id={selectedBatchId} onClose={() => setSelectedBatchId(null)} />
      )}
      {editingBatchId && (
        <BatchEdit id={editingBatchId} onClose={() => setEditingBatchId(null)} />
      )}
    </>
  );
}
